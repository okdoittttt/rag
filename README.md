...
### Phase 1: 기반 구축
- [ ] 프로젝트 구조 설계 (`src/`, `cli/`, `configs/`, `data/`, `tests/`)
- [ ] 설정 파일 구조 정의 (`configs/default.yaml`)
- [ ] 로깅 시스템 구축 (구조화 JSON 로그)

### Phase 2: 문서 수집 (Ingestion)
- [ ] 텍스트 파일 로더 구현 (`.txt`, `.md`)
- [ ] 문서 정규화 (공백/개행 정리, 메타데이터 추출)
- [ ] 언어 감지 (한국어/영어)

### Phase 3: 청킹 (Chunking)
- [ ] 기본 청킹 로직 (300-800 토큰 또는 800-2000자)
- [ ] 오버랩 처리 (10-20%)
- [ ] 구조 보존 (헤더/섹션 경계)

### Phase 4: 임베딩 & 인덱싱
- [ ] 임베딩 모델 선정 및 연동
- [ ] 벡터 저장소 구현 (로컬 기반: FAISS 또는 Chroma)
- [ ] 인덱스 저장/로드 기능
